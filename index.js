...
console.log("Connecting 𝗖𝗛𝗔𝗟𝗔𝗛 𝗢𝗙𝗖 𝗠𝗗 BOT 💫...");
...
let up = `🚀 *_𝗖𝗛𝗔𝗟𝗔𝗛 𝗢𝗙𝗖 𝗠𝗗 Connected Successfully!_* ✅ 

--- *😈🎉 _Welcome to 𝗖𝗛𝗔𝗟𝗔𝗛 𝗢𝗙𝗖 𝗠𝗗 BOT!_* 🎉😈 

*🔹 PREFIX:* ${prefix}
*🔹 OWNER:* ${ownerNumber}
*🔹 MADE BY:* chalana induwara
_*🕺Enjoy your time with us!😊*_

*👨‍💻CHALAH - MD  ᴍᴀᴅᴇ ʙʏ CHALANA INDUWARA👨‍💻* `;

await conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://i.ibb.co/DHbt8KY2/SulaMd.jpg` }, caption: up })
...
//=========OWNER - REACTION ===============================  
if(senderNumber.includes("94776938000")){
if(isReact) return
m.react("👨🏻‍💻")
}
if(senderNumber.includes("94784919934")){
if(isReact) return
m.react("🌜")
}
if(senderNumber.includes("940701024060")){
if(isReact) return
m.react("™")
}
if(senderNumber.includes("94761213327")){
if(isReact) return
m.react("™")
}
if(senderNumber.includes("94762324830")){
if(isReact) return
m.react("👾")
}
//=====================✓
...
app.get("/", (req, res) => {
res.send("hey, 𝗖𝗛𝗔𝗟𝗔𝗛 𝗢𝗙𝗖 𝗠𝗗 started✅");
});
